<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="production_completionList" @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55" align="center" />
        <el-table-column fixed label="生产批号" align="center" prop="batchNumber" />
        <el-table-column label="生产主管" align="center" prop="productionSupervisor" />
        <el-table-column label="生产计划是否完成" align="center" prop="ifCompleted" />
        <el-table-column label="检验结果" align="center" prop="inspectionResults" />
        <el-table-column label="备注" align="center" prop="productionRemark" />
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="135px">
          ...
          <el-form-item label="是否完成生产计划" prop="ifCompleted">
            <el-input v-model="form.ifCompleted" placeholder="请输入结果" />
          </el-form-item>
          <el-form-item label="检验结果" prop="inspectionResults">
            <el-input v-model="form.inspectionResults" placeholder="请输入检验结果" />
          </el-form-item>
          <el-form-item label="备注" prop="productionRemark">
            <el-input v-model="form.productionRemark" placeholder="请输入备注" />
          </el-form-item>
        </el-form>
  ...
  export default {
    ...
    methods: {
        ...
        this.loading = true;
        this.loading = false;
        this.production_completionList=[{
            batchNumber: "111",
          productionSupervisor: "222",
          ifCompleted:"333",
          inspectionResults:"444",
          remark:"555"
          },{
            batchNumber: "1",
