<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="raw_material_requisitionList" @selection-change="handleSelectionChange">
        ...
        <el-table-column width = "150" label="领用数量" align="center" prop="receivedQuantity" />
        ...
        <el-table-column width = "150" label="备注" align="center" prop="rawMaterialRemark" />
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
          ...
          <el-form-item label="领用数量" prop="receivedQuantity">
            <el-input v-model="form.receivedQuantity" placeholder="请输入领用数量" />
          </el-form-item>
  ...
  export default {
    ...
    methods: {
        ...
        this.loading = true;
        this.loading = false;
        this.raw_material_requisitionList=[{ 
            batchNumber: "1111",
          materialRequisitionPersonnel: "111",
          receivedQuantity: "0022",
          productionSupervisor: "111",
          yieldProduction: "111",
          inventoryQuantity: "0",
          rawMaterialRemark:"erws"
          },{
            batchNumber: "1111",
          materialRequisitionPersonnel: "111",
          receivedQuantity: "0022",
