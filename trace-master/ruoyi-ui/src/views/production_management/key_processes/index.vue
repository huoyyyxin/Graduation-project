<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="key_processesList" @selection-change="handleSelectionChange">
        ...
        <el-table-column width = "150" label="备注" align="center" prop="productionRemark" />
