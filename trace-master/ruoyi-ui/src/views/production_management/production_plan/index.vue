<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="production_planList" @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55" align="center" />
        <el-table-column fixed width = "150" label="生产批号" align="center" prop="batchNumber" />
        <el-table-column width = "150" label="制单员" align="center" prop="voucherMaker" />
        ...
        <el-table-column width = "200" label="库存数量不足进行警报" align="center" prop="insufficientAlarm" />
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
          ...
          <el-form-item label="制单员" prop="voucherMaker">
            <el-input v-model="form.voucherMaker" placeholder="请输入制单员姓名" />
          </el-form-item>
          ...
          <el-form-item label="所需数量" prop="requiredQuantity">
            <el-input v-model="form.requiredQuantity" placeholder="请输入所需数量" />
          </el-form-item>
          <el-form-item label="库存数量" prop="inventoryQuantity">
            <el-input v-model="form.inventoryQuantity" placeholder="请输入库存数量" />
          </el-form-item>
          <el-form-item label="库存不足警报" prop=" insufficientAlarm ">
            <el-input v-model="form.materiaName" placeholder="请显示剩余库存情况" />
          </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          ...
          voucherMaker: [
            { required: true, message: "制单员不能为空", trigger: "blur" }
          ],
    ...
    methods: {
        ...
        this.loading = true;
        this.loading = false;
        this.production_planList=[{ 
            batchNumber: "111",
          voucherMaker: "001",
          productionSupervisor: "111",
          yieldProduction: "001",
          requiredRawMaterials: "222",
          requiredQuantity: "2221",
          inventoryQuantity: "111",
          insufficientAlarm: "000",
          remark:"003"
          },{
            batchNumber: "111",
          voucherMaker: "001",
