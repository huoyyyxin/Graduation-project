<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="密码" align="center" prop="jobRemarks" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="员工编号" prop="jobName">
          <el-input v-model="form.jobName" placeholder="请输入编号" />
        </el-form-item>
        <el-form-item label="密码" prop="jobRemarks">
          <el-input v-model="form.jobRemarks" placeholder="请输入密码" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      // this.$modal.confirm('是否确认删除job编号为"' + jobIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      // this.download('trace/job/export', {
      //   ...this.queryParams
