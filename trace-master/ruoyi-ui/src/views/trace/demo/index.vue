<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="生产编号" align="center" prop="jobId" />
      <el-table-column label="名称" align="center" prop="jobName" />
      <el-table-column label="备注" align="center" prop="jobRemarks" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="备注" prop="jobRemarks">
          <el-input v-model="form.jobRemarks" placeholder="请输入备注" />
        </el-form-item>
      </el-form>
