<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="purchase_arrivalList" @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55" align="center" />
        <el-table-column fixed width = "150" label="采购到货单编号" align="center" prop="purchaseDeliveryNoteNumber" />
        <el-table-column width = "150" label="采购计划单编号" align="center" prop="purchasingPlanNumber" />
        ...
        <el-table-column width = "150" label="到货数量" align="center" prop="receivedQuantity" />
        <el-table-column width = "150" label="质检状态标志" align="center" prop="qualityInspectionStatusFlag" />
        <el-table-column width = "150" label="到货日期" align="center" prop="expectedDeliveryDate" />
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
          ...
          <el-form-item label="质检状态标志" prop="qualityInspectionStatusFlag">
            <el-input v-model="form.qualityInspectionStatusFlag" placeholder="请输入质检状态标志" />
          </el-form-item>
          <el-form-item label="到货日期" prop="expectedDeliveryDate">
            <el-input v-model="form.expectedDeliveryDate" placeholder="请输入到货日期" />
          </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryParams: {
          ...
          qualityInspectionStatusFlag:null,
        ...
        rules: {
          ...
          qualityInspectionStatusFlag: [
            { required: true, message: "质检状态标志不能为空", trigger: "blur" }
          ],
        }
      };
    },
    ...
    methods: {
        ...
        this.loading = true;
        this.loading = false;
        this.purchase_arrivalList=[{
          purchaseDeliveryNoteNumber: "111",
          purchasingPlanNumber: "222",
          creatorID:"333",
          productionDate:"444",
          materialCode:"555",
          batchNumber:"666",
          receivedQuantity:"777",
          qualityInspectionStatusFlag:"888",
          expectedDeliveryDate:"999",
          remark :"0.0"
          },{
          purchaseDeliveryNoteNumber: "111",
          purchasingPlanNumber: "222",
